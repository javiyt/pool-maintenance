...
export const PERSISTENCE_INVENTORY = [
  ...
  {
    entity: 'measurement-devices',
    storage: 'localStorage',
    storageKey: 'measurementDevices',
    exported: true,
    imported: true,
    migrationStrategy: 'Normalize device capability schema and preserve calibration and derivation metadata.',
    conflictStrategy: 'Deduplicate by stable device id. Same id with different calibration requires conflict review.',
    containsSensitiveData: false,
    regenerable: false,
    schemaVersion: '1',
    category: 'exportable-importable',
    portablePath: 'data/equipment.json',
  },
  {
